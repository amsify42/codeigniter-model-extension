...
```
As you can see, we are passing two key **name** and **modify**. modify having some value along with text **COL** having underscore at beginning and end. Whatever the value come from table column name. It will contain the extra value we passing along with **COL**
